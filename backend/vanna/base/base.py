...
class VannaBase(ABC):
    ...
    def get_sql_prompt(
        ...
        **kwargs,
        ...
        initial_prompt += (
            ...
            "6. Please use like operator instead of equal to when noun is found in question and use wildcard in between \n"
    ...
    def get_followup_questions_custom(
        self,
        question: str,
        question_sql_list: list,
        ddl_list: list,
        ...
        **kwargs,
        ...
        initial_prompt = f"Table or view name: '{question}': \n\n"
        ...
        message_log.append(
            self.user_message(
                "Generate a list of 3 followup questions that the user might ask about this data. Respond with a list of questions, one per line. Do not answer with any explanations -- just the questions and return in python string format delimited by |||. If no questions found return empty string"
            )
        )
